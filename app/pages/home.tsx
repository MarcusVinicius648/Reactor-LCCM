...
import { SafeAreaView,Text,StyleSheet, View, TouchableOpacity, StatusBar, Image } from "react-native";
...
export default function Home(){
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity activeOpacity={0.7} style={{width:'100%'}} onPress={()=>navigation.navigate("HistoryScreen")}> 
